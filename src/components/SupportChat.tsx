    ...
    <div className="space-y-3">
      ...
      {step === 'name' && (
        <form onSubmit={onNameSubmit} className="space-y-2">
          ...
          <button
            type="submit"
            className="w-full py-2 bg-neutral-950 text-white text-sm font-bold rounded-full"
          >
            {t('support.next')}
          </button>
        </form>
        ...
        <div className="space-y-2">
          ...
          {topicKeys.map((key) => (
            <button
              ...
              className={`w-full text-left px-3 py-2 text-sm border rounded-lg hover:bg-neutral-100 ${
      ...
      {step === 'detail' && (
        <form onSubmit={onDetailSubmit} className="space-y-2">
          ...
          <textarea
            ...
            className="w-full px-3 py-2 text-sm border border-neutral-300 rounded-lg focus:outline-none focus:border-neutral-900 resize-none"
            required
          />
          <button
            type="submit"
